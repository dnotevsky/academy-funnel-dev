...
if( $_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name'], $_POST['email']) ) {
    if($_POST['page-form'] == true) {
        addFromFormWithTag($_POST['name'], $_POST['email'], isset($_POST['phone']) ? $_POST['phone'] : '-', "Заявка бронь участия с /academy-full/", "academy-full");
    } else {
        addFromFormWithTag($_POST['name'], $_POST['email'], isset($_POST['phone']) ? $_POST['phone'] : '-', "Заявка на консультацию с /academy-full/", "academy-full");
    }
