...
$(function() {
	$("[name=send]").click(function () {
		...
		if(!(error==1)) {
			...
			function goJs() {window.location = 'https://events.genndi.com/ew/auto-register?webicode=6eb2012475&memberid=169105139238453049&firstname='+ name +'&email='+ email +'&phonenumber='+ phone +'&schedule=1'};

            if( form && name && email && phone) {
